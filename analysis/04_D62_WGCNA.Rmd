    ...
    for(Tp in Type_sgRNA){
      ...
      vs_label=paste0(Tp, sep="", collapse="_")
        Set = rownames(SampleInfo)[Rapafilter&Difffilter&
                                     sgRNAfilter]
        lab = paste("restabWGCNA", "D62", vs_label, d,r, sep="_")
...
save(list = comparisons, file = paste0(home,"/output/D62_ResTabs_KO_WGCNA.RData"))
...
getWGCNAoutputs = function(targetline="D62",targetdiff,targetrapa){
...
```{r noDIFF_noRAPA_D62}
getWGCNAoutputs(targetdiff = "noDIFF",targetrapa = "noRAPA")
...
write.xlsx2(toptab, file = paste0(output,"/D62_GOresWGCNA.xlsx"), sheetName = "GO_enrichment")
