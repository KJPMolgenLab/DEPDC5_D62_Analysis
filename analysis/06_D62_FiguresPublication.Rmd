...
pdf(paste0(home,"./docs/Publication_figure1.pdf"), width = 12, height = 15)
finplot
dev.off()
...
pdf(paste0(home,"./docs/Publication_figure2.pdf"), width = 12, height = 15)
finplot
dev.off()
...
pdf(paste0(home,"./docs/Publication_figure3.pdf"), width = 12, height = 15)
finplot
dev.off()
